def reg_default_ops():
    ...
    return {
        ...
        "do_bidiphase": 1,  # whether or not to compute bidirectional phase offset (applies to 2P recordings only)
        "bidiphase": 0,  # Bidirectional Phase offset from line scanning (set by user). Applied to all frames in recording.
        "bidi_corrected": 1,  # Whether to do bidirectional correction during registration
